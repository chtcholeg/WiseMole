...
public class ImageControl extends ControlBase {
	...
	public void paint(Graphics graphics) {
		...
		if (selection) {
			...
			graphics2d.drawLine(position.x + position.width, position.y, position.x + position.width, position.y + position.height);
			graphics2d.drawLine(position.x + position.width, position.y + position.height, position.x, position.y + position.height);
