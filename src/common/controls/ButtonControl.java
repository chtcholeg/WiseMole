...
public class ButtonControl extends ControlBase {
    ...
    public void paint(Graphics graphics) {
        ...
        graphics.drawImage(middleImage, position.x + leftWidth, position.y, position.width - leftWidth - rightWidth,
                position.height, null);
        graphics.drawImage(rightImage, position.x + position.width - rightWidth, position.y, rightWidth,
                position.height, null);
