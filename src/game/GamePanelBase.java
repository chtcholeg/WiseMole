			...
			
{
	...
	protected Point findCellUnderPoint(Point point) {
		...
		final int columnIndex = (int) ( (double) point.x / (double)renderDetails.fieldArea.width * (double) fieldSize.width );
		final int rowIndex = (int) ( (double) point.y / (double)renderDetails.fieldArea.height * (double) fieldSize.height );
	...
	static private Dimension calcCellSize(Dimension fieldSize, Rectangle workingRect) 
	{
 	...
 	private Rectangle calcCellRect(int x, int y) 
 	{
		return new Rectangle(
			renderDetails.fieldArea.x + renderDetails.cellSize.width * x, 
			renderDetails.fieldArea.y + renderDetails.cellSize.height * y, 
			renderDetails.cellSize.width, 
